...
CREATE TABLE "employees" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "employees_wallet_address_payment_group_id_unique" UNIQUE("wallet_address","payment_group_id")
);
--> statement-breakpoint
CREATE TABLE "last_yield_routes" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"payment_group_pool_id" uuid NOT NULL,
	"protocol" text NOT NULL,
	"yield_type" text NOT NULL,
	"allocation_pct" numeric NOT NULL,
	CONSTRAINT "last_yield_routes_payment_group_pool_id_protocol_unique" UNIQUE("payment_group_pool_id","protocol")
);
--> statement-breakpoint
...
CREATE TABLE "payment_group_pools" (
	...
	CONSTRAINT "payment_group_pools_payment_group_id_token_unique" UNIQUE("payment_group_id","token")
);
--> statement-breakpoint
...
ALTER TABLE "employees" ADD CONSTRAINT "employees_payment_group_id_payment_groups_id_fk" FOREIGN KEY ("payment_group_id") REFERENCES "public"."payment_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "last_yield_routes" ADD CONSTRAINT "lyr_pgp_fk" FOREIGN KEY ("payment_group_pool_id") REFERENCES "public"."payment_group_pools"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payment_group_pools" ADD CONSTRAINT "payment_group_pools_payment_group_id_payment_groups_id_fk" FOREIGN KEY ("payment_group_id") REFERENCES "public"."payment_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_employees_group" ON "employees" USING btree ("payment_group_id");--> statement-breakpoint
CREATE INDEX "idx_employees_wallet" ON "employees" USING btree ("wallet_address");--> statement-breakpoint
CREATE INDEX "idx_lyr_pool" ON "last_yield_routes" USING btree ("payment_group_pool_id");--> statement-breakpoint
CREATE INDEX "idx_pgp_group" ON "payment_group_pools" USING btree ("payment_group_id");--> statement-breakpoint
