...
const links = ["Home", "About", "Solutions", "Pricing", "Contact"];

export function Navbar() {
  return (
    <header className="absolute inset-x-0 top-6 z-30 flex items-center justify-between px-24">
      <Logo dark />
      ...
      <div className="flex items-center gap-3">
        <a className="hidden text-[13px] font-medium text-white sm:inline" href="#home">
          Log in
        </a>
        <a
